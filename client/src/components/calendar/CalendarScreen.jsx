...
import {
  ...
  eventStartLoading,
  eventUpdate,
} from "../../actions/event"; // Import eventUpdate action
import AddNewBtn from "../ui/AddNewBtn";
import DeleteBtn from "../ui/DeleteBtn";
...
const CalendarScreen = () => {
  ...
  const onUpdate = (updatedEvent) => {
    dispatch(eventUpdate(updatedEvent));
  }; // Define the onUpdate event handler
    ...
    <div className="calendar">
      ...
      <div className="calendar__container">
        <Calendar
          ...
          view={lastView}
          components={{ event: CalendarEvent }}
          onUpdate={onUpdate} // Pass the onUpdate event handler
        />
      </div>
      {activeEvent && !modalOpen && <DeleteBtn />}
      <AddNewBtn />
