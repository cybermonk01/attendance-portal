...
const LoginScreen = () => {
  ...
  const handleBoxClick = () => {
    // Set the respective values in the input fields when the box is clicked

    handleInputChange({ target: { name: "email", value: "user1@test.com" } });
    handleInputChange({ target: { name: "password", value: "User@123" } });
  };
    ...
    <section className="card">
      ...
      <div className="card__row card__row--colored card__row--left">
        <div className="card__body">
          ...
          <div
            className="clickable-box btn btn-primary--outline"
